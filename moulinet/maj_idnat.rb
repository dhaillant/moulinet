...
#	afficher_10_premiers liste_kwartz_sans_idext
	...
	liste_kwartz.each do |eleve_kwartz|
		...
		# chercher les homonymes dont l'IDNAT est DIFFERENT ou INEXISTANT
		...
		if homonymes.length > 0
			...
			puts "Pas de correspondance trouvée ou IDNAT identique...\n\n"
		end
	end
...
#	puts "\n\n"
	...
	liste_kwartz = affecter_id_national liste_sconet, liste_kwartz - exclus
